...
export default function Index({ features }) {
  ...
  useGSAP(() => {
    ...
    mm.add("(min-width: 1025px)", () => {
      ...
      tl.to(
        projectFeatures.current.children[1],
        {
          top: "-0.25rem",
        },
        "a",
        ...
        .to(
          projectFeatures.current.children[0],
          {
            scale: ".65",
            marginTop: "-3.1rem",
          },
        ...
        .to(
          projectFeatures.current.children[2],
          {
            top: "24%",
          },
          "a",
      ...
      tl.to(
        ...
        .to(
          projectFeatures.current.children[3],
          {
            top: "24%",
          },
          "b",
      ...
      tl.to(
        ...
        .to(
          projectFeatures.current.children[3].children[0].children[1],
          {
            marginTop: "-5.625rem",
          },
          "c",
  ...
  return (
    <div
      ref={projectFeaturesWrapper}
      className={styles["project-features-wrapper"]}
    >
      <div
        ref={projectFeaturesHeader}
        className={styles["project-features-header"]}
      >
        <h2>
